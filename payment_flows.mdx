...
![Tokenized Payment Flow Diagram](assets/tokenized-payment-flow.svg)
...
![3-D Secure Payment Flow Diagram](assets/3-D-secure-payment-flow.svg)
...
![Redirect Payment Flow Diagram](assets/redirect-payment-flow.svg)
...
![Card Payment Flow Diagram](assets/card-payment-flow.svg)
